...
router.post('/create_payment_url', function (req: Request, res: Response) {
...
//     let vnp_IpAddr = req.headers['x-forwarded-for'] || req.connection.remoteAddress || req.socket.remoteAddress;
